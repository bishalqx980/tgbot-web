...
function attach() {
    ...
    if (bot_api != "") {
        ...
        api.onload = function() {
            ...
            if (api_res == 200) {
                log.innerHTML = "bot attached successfully!";
            }else {
                log.innerHTML = "<span style='color: rgb(255, 0, 0);'>bot api changed or bot deleted!</span>";
            }
        }
    }else {
        log.innerHTML = "`<u>bot token</u>` can't leave empty!"
    } 
}
// setting
function setting() {
...
function save_value() {
    ...
    document.getElementById("log").innerHTML = "value's saved successfully!"
}
